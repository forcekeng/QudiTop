...
def get_pauli_x_gate_cmatrix(
    dim: int, ind: Iterable, ctrl_states: List = None
) -> Tuple:
...
def get_rotate_x_gate_cmatrix(
    dim: int, ind: Iterable, pr: Parameter, ctrl_states: List = None
) -> Tuple:
...
class PauliNoneParamGate(NoneParamGate):
    ...
    def __init__(
        ...
        super().__init__(dim, obj_qudits, ctrl_qudits, ctrl_states, name)
        assert (
            isinstance(ind, Iterable) and len(ind) == 2
        ), "The `ind` should be a iterable object with 2 elements."
...
class H(NoneParamGate):
    ...
    def __init__(
        self, dim: int, obj_qudits=None, ctrl_qudits=None, ctrl_states=None, name="H"
    ):
        super().__init__(dim, obj_qudits, ctrl_qudits, ctrl_states, name)
...
class RX(PauliWithParamGate):
    ...
    def _cmatrix(self):
        return get_rotate_x_gate_cmatrix(
            self.dim, self.ind, self.param, self.ctrl_states
        )
...
class RY(PauliWithParamGate):
    ...
    def _cmatrix(self):
        return get_rotate_y_gate_cmatrix(
            self.dim, self.ind, self.param, self.ctrl_states
        )
...
class RZ(PauliWithParamGate):
    ...
    def _cmatrix(self):
        return get_rotate_z_gate_cmatrix(
            self.dim, self.ind, self.param, self.ctrl_states
        )
...
class INC(NoneParamGate):
    ...
    def __init__(
        self, dim: int, obj_qudits=None, ctrl_qudits=None, ctrl_states=None, name="INC"
    ):
        super().__init__(dim, obj_qudits, ctrl_qudits, ctrl_states, name)
